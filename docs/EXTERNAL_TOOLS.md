...
If an external tool produces a candidate field-kernel circuit, port the
reusable idea into `src/shor_oracle/field_arithmetic.rs` and rerun the trusted
evaluator before making any score claim.
